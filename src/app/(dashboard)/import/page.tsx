    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <span className="font-medium text-blue-800">Formato CSV richiesto:</span>
        </div>
        <p className="text-sm text-blue-700">
          <strong>Colonne:</strong> Docente; Minuti/Settimana; Tesoretto Annuale (min); Moduli Annui (50 min); Saldo (min)
          <br />
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
                <p className="font-medium text-blue-800">{importResult.message}</p>
              </div>
